...
router.post('/old', auth, async (req, res) => {
  try {
    const { name, description, price, sizes, category, brand, images } = req.body;
...
router.put('/:id', auth, async (req, res) => {
  try {
    ...
    product.images = images ? (typeof images === 'string' ? JSON.parse(images) : images) : product.images;
